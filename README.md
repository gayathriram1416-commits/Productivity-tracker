...
**Deployed on AWS EC2**: http://15.206.107.9:8080
...
**Start / Stop / Reset productivity timer**
Tracks clock-in and clock-out time per session
Daily productivity report with session history
